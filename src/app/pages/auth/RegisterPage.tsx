...
function InputField({ label, type = "text", value, onChange, placeholder, icon: Icon, extra }: any) {
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 w-[480px] flex-shrink-0 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #0a2010 0%, #1B5E20 60%, #0a2010 100%)" }}>
        ...
        <div className="relative">
          <p className="font-['Poppins',sans-serif] font-bold text-white text-4xl mb-4 leading-tight">
            Bergabung &<br />
            <span style={{ background: "var(--c-gradient-r)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Mulai Cetak!</span>
          </p>
          ...
          <div className="flex flex-col gap-3">
            {["Konsultasi desain gratis untuk member baru", "Diskon 10% untuk pesanan pertama", "Lacak pesanan real-time"].map((t, i) => (
              <motion.div key={t} initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 + i * 0.1 }} className="flex items-center gap-3">
