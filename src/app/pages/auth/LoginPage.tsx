...
import { Mail, Lock, Eye, EyeOff, CheckCircle2, Zap, Shield, Award } from "lucide-react";
...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 w-[520px] flex-shrink-0 relative overflow-hidden" style={{ background: "linear-gradient(135deg, #1B5E20 0%, #0a2010 50%, #1B5E20 100%)" }}>
        {/* Grid pattern */}
        <div
        ...
        <div className="relative">
          ...
          >
            Solusi Cetak
            <br />
            <span style={{ background: "var(--c-gradient-r)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Premium Aceh</span>
          </motion.p>
          ...
          <div className="flex flex-col gap-4">
            {FEATURES.map(({ Icon, text }, i) => (
              <motion.div key={text} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 + i * 0.15 }} className="flex items-center gap-3">
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12" style={{ background: v("--c-bg") }}>
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-[420px]">
          {/* Mobile logo */}
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <button
              type="button"
              className="w-full py-3 rounded-xl border text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-200"
              style={{ border: `1.5px solid ${v("--c-border")}`, color: v("--c-text"), fontFamily: "'Inter',sans-serif", background: v("--c-bg-sec") }}
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  style={{ background: v("--c-card"), color: v("--c-primary"), border: `1px solid ${v("--c-border")}`, fontFamily: "'Inter',sans-serif" }}
                >
                  {label}
                </button>
              ))}
