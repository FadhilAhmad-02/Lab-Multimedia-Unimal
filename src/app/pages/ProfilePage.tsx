...
import { v, cs, Section, SectionHeader, BtnPrimary, CTASection } from "../components/pageUtils";
import { ImageWithFallback } from "../components/figma/ImageWithFallback";
import { OutlineFillButton } from "../components/ui/outline-fill-button";

/* ── Images ──────────────────────────────────────────────────── */
const IMG_CAMPUS  = "https://images.unsplash.com/photo-1633572528544-14ef28057921?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx1bml2ZXJzaXR5JTIwYWR2ZXJ0aXNpbmclMjBwcmludGluZyUyMGNhbXB1c3xlbnwxfHx8fDE3NzE5MjI3OTB8MA&ixlib=rb-4.1.0&q=80&w=1080";
const IMG_TEAM   = "https://images.unsplash.com/photo-1761818645907-8bed418b415b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcmludGluZyUyMG9mZmljZSUyMHRlYW0lMjBwcm9mZXNzaW9uYWwlMjB3b3Jrc3BhY2V8ZW58MXx8fHwxNzcxOTIyNzkwfDA&ixlib=rb-4.1.0&q=80&w=1080";
...
const VISI_MISI = {
  visi:
    "Menjadi pusat layanan percetakan dan advertising terdepan di Aceh Utara yang menghasilkan produk berkualitas tinggi, inovatif, dan terjangkau bagi seluruh lapisan masyarakat.",
  misi: [
...
function ProfileHero() {
  return (
    <section className="relative pt-28 pb-20 overflow-hidden" style={{ minHeight: 420 }}>
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-10 flex flex-col items-center text-center">
        ...
        >
          ...
          <span style={{ color: "var(--c-accent)" }}>Profile</span>
        </motion.div>
        ...
        >
          Unit usaha percetakan profesional di bawah naungan Universitas Malikussaleh
          yang melayani kebutuhan cetak dan advertising dengan kualitas premium.
        </motion.p>
        ...
        <motion.div
          ...
          className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-16 max-w-3xl mx-auto"
        >
          {STATS.map((s) => (
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            >
              <strong style={{ color: v("--c-text") }}>Malikussaleh Advertising</strong> adalah
              unit usaha percetakan dan advertising yang beroperasi di bawah Universitas
              Malikussaleh, Aceh Utara. Berdiri sejak tahun 2025, kami hadir sebagai solusi
              lengkap untuk segala kebutuhan cetak custom individu maupun instansi.
            </p>
            <p
            ...
            >
              Dengan dukungan sumber daya Universitas Malikussaleh dan tim profesional
              berdedikasi, kami berkomitmen menghadirkan hasil cetakan berkualitas tinggi
              dengan harga yang kompetitif dan pelayanan yang ramah serta cepat.
            </p>
          ...
          >
            ...
            >
              <ImageWithFallback
                src={IMG_TEAM}
                alt="Tim Malikussaleh Advertising"
            ...
            >
              <p
                className="text-white/90 text-xs font-semibold tracking-widest"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3
                className="font-['Poppins',sans-serif] font-bold text-xl"
              ...
              {VISI_MISI.misi.map((item, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span
                    ...
                    style={{ background: v("--c-gradient-r"), fontSize: "0.65rem" }}
                  >
                    {i + 1}
                  </span>
                  <p
  ...
  const contacts = [
    {
      Icon: MapPin,
      label: "Alamat",
      value: "Reuleut Timur, Kec. Muara Batu, Kab. Aceh Utara, Aceh 24355",
    },
    {
      Icon: Phone,
    ...
    },
    {
      Icon: Mail,
      label: "Email",
      value: "multimedia@unimal.ac.id",
    },
    {
      Icon: Clock,
      label: "Jam Operasional",
      value: "Senin - Sabtu: Pukul 08:00-17:00 WIB",
    },
  ];
